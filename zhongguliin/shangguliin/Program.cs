    ...
    class Program
    {
        ...
        private static void Gi3Shang4Gu3Biao3Ja1Pin1In1()
        {
            ...
            for (int k = 0; k < 9720; k++)
            {
                ...
                {
                    while (dt2.Rows[i][0].ToString().Trim() + dt2.Rows[i][1].ToString().Trim() + dt2.Rows[i][2].ToString().Trim() + dt2.Rows[i][3].ToString().Trim() + dt2.Rows[i][4].ToString().Trim() != sdhüd)
                    {
                        i++;
                    }
                    if (i < 3885)
